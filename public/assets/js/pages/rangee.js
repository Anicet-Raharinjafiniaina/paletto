...
function view(id, action) {
    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            chargeSelectedFromController('entrepot_id_upd', 'allee_id_upd', 'Rangee/getAllAlleeByEntrepot', 'modal_view_rangee', { entrepot_id: $('#entrepot_id_upd').val() }, 'allee_id_base');

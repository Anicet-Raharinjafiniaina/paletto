            ...
            return $.ajax({
                ...
                if (response === 1) {
                    ...
                    Swal.fire({
                        ...
                        html: "Impossible de faire la suppression car l'emplacement associé à cette allée est <b>occupé</b>.",
                        icon: "warning",
                        showConfirmButton: true,
                    });
                } else {
                    ...
                    success: function (res) {
                        ...
                        if (res == 1) {
                            ...
                            Swal.fire({
                                ...
                                html: "Impossible de faire la modification car l'emplacement associé à cette allée est <b>occupé</b>.",
                                icon: "warning",
                                showConfirmButton: true,
                            });
                            $("#save_upd").prop("disabled", false);
